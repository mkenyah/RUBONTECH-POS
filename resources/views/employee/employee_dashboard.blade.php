...
<div class="col-xl-3 col-md-6 mb-4">
    <div class="card border-left-danger shadow h-100 py-2">
        <div class="card-body">
            <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                    <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">Repairs (Today)</div>
...
<div class="col-xl-3 col-md-6 mb-4">
    <div class="card border-left-warning shadow h-100 py-2">
        <div class="card-body">
            <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                    <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Photocopies (Today)</div>
...
<div class="col-xl-3 col-md-6 mb-4">
    <div class="card border-left-info shadow h-100 py-2">
        <div class="card-body">
            <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                    <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Printing (Today)</div>
    ...
    <div class="card-body" style="font-size: 0.9rem;">
        @forelse($mostSold as $item)
            <p class="mb-2 font-weight-bold">
                {{ $item->product_name }} 
                <span class="float-end">{{ $item->percentage }}%</span>
            </p>
            <div class="progress mb-3" style="height: 1rem;">
                <div class="progress-bar 
                    {{ $item->percentage >= 80 ? 'bg-success' : ($item->percentage >= 60 ? 'bg-info' : ($item->percentage >= 40 ? 'bg-primary' : ($item->percentage >= 20 ? 'bg-warning' : 'bg-danger'))) }}" 
                    role="progressbar" 
