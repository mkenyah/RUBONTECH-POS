            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">Products</a>
                    </div>
...
<script>
   ...
   <form action="{{ route('products.store') }}" method="POST">
        ...
        <div class="mb-3">
            <label for="buying_price" class="form-label"> Buying Price (per_item)</label>
        ...
        <div class="mb-3">
            <label for="selling_price" class="form-label">Selling Price (Per_item)</label>
