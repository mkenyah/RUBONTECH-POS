...
<script>
    ...
    <div class="input-group">
        ...
        <span class="input-group-text" onclick="togglePasswordVisibility('password', 'toggleIcon1')" style="cursor: pointer;">
...
<div class="mb-3 position-relative">
    ...
    <div class="input-group">
        ...
        <span class="input-group-text" onclick="togglePasswordVisibility('password_confirmation', 'toggleIcon2')" style="cursor: pointer;">
