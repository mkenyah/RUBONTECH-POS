...
<div class="card shadow mb-4">
    <div class="card-header py-3 d-flex justify-content-between align-items-center">
        <h6 class="m-0 font-weight-bold text-primary">Repairs Table</h6>
...
<div class="card-body">
    ...
    @method('PATCH')
                        ...
                        <td>{{ \Carbon\Carbon::parse($repair->created_at)->format('d M Y, h:i A') }}</td>
                    </tr>
                @empty
                    <tr>
                        <td colspan="10" class="text-center">No repair records found.</td>
                    </tr>
                @endforelse
            </tbody>
            @if(count($repairs) > 0)
...
<a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" onclick="printReport()">Print Report</a>

<!-- Start of Printable Report -->
<div id="printable-report-products" style="display: none;">
...
<!-- Hide content for printing except printable area -->
<style>
@media print {
    body * {
...
<!-- Sidebar accordion collapse logic -->
<script>
