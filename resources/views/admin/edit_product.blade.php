...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">Products Editing</a>
</div>
...
<script>
    ...
    <form action="{{ route('admin.product_update', $product->id) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="number" step="0.01" name="buying_price" class="form-control" value="{{ old('buying_price', $product->buying_price) }}" required>
            @error('buying_price')
                <small class="text-danger">{{ $message }}</small>
            @enderror
        </div>
