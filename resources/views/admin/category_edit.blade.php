            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">Categories Editting</a>
                    </div>
...
<script>
    ...
    <script>
        setTimeout(function() {
            window.location.href = "{{ route('admin.categories_table') }}";
    ...
    {{-- The action route will be different, and we'll use PUT method --}}
    {{-- <form action="{{ route('admin.category_edit', $category->id) }}" method="POST">
        @csrf
        @method('PUT')  --}}
    ...
    @method('PUT'){{-- This spoofs the PUT method for updates --}}
        ...
        <div class="mb-3">
            ...
            {{-- Value is pre-filled with existing category name --}}
            <input type="text" class="form-control" id="name" name="name" value="{{ old('name', $category->name) }}" required>

            @error('name') {{-- Note: Changed from 'category_name' to 'name' to match input's name attribute --}}
        ...
        <div class="mb-3">
            ...
            {{-- Textarea content is pre-filled with existing description --}}
