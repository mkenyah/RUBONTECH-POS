                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Repairs (Today)
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 font-weight-bold text-gray-800">Ksh {{ number_format($repairs, 2) }}</div>
                                                </div>
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Printing(Today)
                          ...
                          <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">OTHER SERVICES TODAY(Today)
                           ...
                           <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">PROFIT(Today)
...
<div class="card shadow mb-3 w-100">
    <div class="card-header py-2">
        <h5 class="m-0 font-weight-bold text-primary text-center">Most Sold Items</h5>
    </div>
    <div class="card-body" style="font-size: 0.9rem;">
        @foreach ($mostSold as $product)
            ...
            <div class="progress mb-3" style="height: 1rem; width: 100%;">
                <div class="progress-bar 
                    @if($product->percentage >= 80)
                        bg-success
                    @elseif($product->percentage >= 60)
                        bg-info
                    @elseif($product->percentage >= 40)
                        bg-primary
                    @elseif($product->percentage >= 20)
                        bg-warning
                    @else
                        bg-danger
                    @endif
