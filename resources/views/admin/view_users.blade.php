...
<div class="container-fluid mt-4">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"  onclick="printUserReport()">
            ...
            <table class="table table-bordered" id="userDataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.user_edit', $user->id) }}" class="btn btn-sm btn-primary">
                                <i class="fas fa-edit"></i>
                            </a>
                            <form action="{{ route('admin.user_destroy', $user->id) }}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
...
!-- Printable Content -->
<div id="printable-user-report" class="d-none">
    <div class="text-center mb-4">
        <h1>INFO_TRACK</h1>
        <h3>Users Report</h3>
        <p>Date Downloaded: {{ now()->format('F d, Y h:i A') }}</p>
    </div>
...
function printUserReport() {
    const report = document.getElementById('printable-user-report');
    report.classList.remove('d-none'); // Show before print
    window.print();
    report.classList.add('d-none'); // Hide after print
}
</script>
